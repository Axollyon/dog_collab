...
const GeoLayout sl_area_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_CLOSE_NODE(),
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_OPAQUE, 20438, 2267, -12262, sl_dl_Lighthouse_mesh_layer_1),
		...
		GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT, 0, -1500, 0, sl_dl_Water_Bottom_Visual_mesh_layer_5),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
...
const GeoLayout sl_dl_Room_3___House_1_geo[] = {
	...
	GEO_OPEN_NODE(),
		...
		GEO_OPEN_NODE(),
			GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -328, 4000, -636, 0, -180, 0, sl_dl_Fishing_Rod_mesh_layer_1),
			GEO_OPEN_NODE(),
				...
				GEO_CLOSE_NODE(),
			GEO_CLOSE_NODE(),
			GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -228, 4000, -636, 0, -180, 0, sl_dl_Fishing_Rod_001_mesh_layer_1),
			GEO_OPEN_NODE(),
				...
				GEO_CLOSE_NODE(),
			GEO_CLOSE_NODE(),
			GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -128, 4000, -636, 0, -180, 0, sl_dl_Fishing_Rod_002_mesh_layer_1),
			GEO_OPEN_NODE(),
				...
				GEO_CLOSE_NODE(),
			GEO_CLOSE_NODE(),
			GEO_TRANSLATE_ROTATE_WITH_DL(LAYER_OPAQUE, -28, 4000, -636, 0, -180, 0, sl_dl_Fishing_Rod_003_mesh_layer_1),
			GEO_OPEN_NODE(),
				...
				GEO_CLOSE_NODE(),
			GEO_CLOSE_NODE(),
			GEO_TRANSLATE_NODE_WITH_DL(LAYER_TRANSPARENT_INTER, 0, 4000, 0, sl_dl_House_1_Indoors_Visual_mesh_layer_7),
			GEO_OPEN_NODE(),
			...
			GEO_CLOSE_NODE(),
			GEO_TRANSLATE_NODE_WITH_DL(LAYER_ALPHA, 550, 4325, 0, sl_dl_Ship_Wheel_mesh_layer_4),
			GEO_TRANSLATE_ROTATE(LAYER_OPAQUE, 85, 4000, 477, 0, 68, 0),
			GEO_OPEN_NODE(),
				GEO_ROTATION_NODE_WITH_DL(LAYER_OPAQUE, 0, -180, 0, sl_dl_Stool_Visual_003_mesh_layer_1),
			GEO_CLOSE_NODE(),
			GEO_TRANSLATE_ROTATE(LAYER_OPAQUE, -285, 4000, 323, 0, 68, 0),
			GEO_OPEN_NODE(),
				GEO_ROTATION_NODE_WITH_DL(LAYER_OPAQUE, 0, -60, 0, sl_dl_Stool_Visual_002_mesh_layer_1),
			GEO_CLOSE_NODE(),
			GEO_TRANSLATE_NODE(LAYER_OPAQUE, 300, 4000, -500),
			GEO_OPEN_NODE(),
				GEO_DISPLAY_LIST(LAYER_OPAQUE, sl_dl_Stool_Visual_mesh_layer_1),
			GEO_CLOSE_NODE(),
			GEO_TRANSLATE_NODE(LAYER_OPAQUE, 300, 4000, -100),
			GEO_OPEN_NODE(),
				GEO_ROTATION_NODE_WITH_DL(LAYER_OPAQUE, 0, 120, 0, sl_dl_Stool_Visual_001_mesh_layer_1),
			GEO_CLOSE_NODE(),
			GEO_TRANSLATE_ROTATE(LAYER_OPAQUE, -100, 4000, 400, 0, 68, 0),
			GEO_OPEN_NODE(),
			...
			GEO_CLOSE_NODE(),
			GEO_TRANSLATE_NODE(LAYER_OPAQUE, 300, 4000, -300),
			GEO_OPEN_NODE(),
