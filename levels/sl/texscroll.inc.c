...
void scroll_sts_mat_sl_dl_Water_Up_layer5() {
	static int intervalTex0 = 2;
	static int curInterval0 = 2;
	static int intervalTex1 = 2;
	static int curInterval1 = 2;
	Gfx *mat = segmented_to_virtual(mat_sl_dl_Water_Up_layer5);
...
void scroll_sl() {
	scroll_sts_mat_sl_dl_Water_Down_layer5();
	scroll_sts_mat_sl_dl_Water_Up_layer5();
